...
#------------------------------
# STRESS TEST 1: BETA=0
#------------------------------

run_stress1 <- ode(times=times, y=start, func=sir,parms=log(1),maxsteps=100000)
run_stress1



# Child HIV Negative Population
df <- as.data.frame(run_stress1[,2:7])
df$year <- 2008:2020
...
ggplot(df, aes(year, Value, group = State, color = State)) +
  ...
  scale_y_continuous(name="Number of HIV Negative Children", labels = scales::comma, breaks=seq(0,11037892,2000000))+
  theme_minimal(base_size = 22)


# Adult HIV Negative Population
df <- as.data.frame(run_stress1[,8:13])
df$year <- 2008:2020
df <- pivot_longer(df, cols = 1:6, names_to = "State", values_to = "Value")
df
ggplot(df, aes(year, Value, group = State, color = State)) +
...
df <- as.data.frame(run_stress1[,14:19])
df$year <- 2008:2020
df <- pivot_longer(df, cols = 1:6, names_to = "State", values_to = "Value")
df
ggplot(df, aes(year, Value, group = State, color = State)) +
  ...
  geom_point() +
  scale_x_continuous("Year", breaks=seq(2008,2020,1))+
  scale_y_continuous(name="Number of HIV Positive Children", labels = scales::comma, breaks=seq(0,2212879,2000000))+
  theme_minimal(base_size = 22)


# Adult HIV Positive Population
df <- as.data.frame(run_stress1[,20:25])
df$year <- 2008:2020
df <- pivot_longer(df, cols = 1:6, names_to = "State", values_to = "Value")
df
ggplot(df, aes(year, Value, group = State, color = State)) +
  ...
  geom_point() +
  scale_x_continuous("Year", breaks=seq(2008,2020,1))+
  scale_y_continuous(name="Number of HIV Positive Adults", labels = scales::comma, breaks=seq(0,2951529,4000000))+
  theme_minimal(base_size = 22)



#--------------------------------------
# STRESS TEST 2: Increase Death Rate
#--------------------------------------
...
sir <- function(t, x, logkappa)  {
  with(as.list(c(logkappa, x)), {
    ...
    # HIV-Positive (children and adults)
    dtb_h   = 0.9       # death rate due to TB in HIV positive individuals 
    d_h     = (1-0.86) +  0.95   # death rate for HIV positive individuals
    x_h     = 0.755     # protection against development of reinfection or developing active TB due to being latently infected or recovered fo HIV positive 
    r_h     = 0.425
    theta_h = 0.00236   # rate of progression to active disease due to existing infection 
...
run_stress2 <- ode(times=times, y=start, func=sir,logkappa_start,maxsteps=100000)
run_stress2



# Child HIV Negative Population
df <- as.data.frame(run_stress2[,2:7])
df$year <- 2008:2020
df <- pivot_longer(df, cols = 1:6, names_to = "State", values_to = "Value")
df
ggplot(df, aes(year, Value, group = State, color = State)) +
...
# Adult HIV Negative Population
df <- as.data.frame(run_stress2[,8:13])
df$year <- 2008:2020
df <- pivot_longer(df, cols = 1:6, names_to = "State", values_to = "Value")
df
ggplot(df, aes(year, Value, group = State, color = State)) +
...
# Child HIV Positive Population
df <- as.data.frame(run_stress2[,14:19])
df$year <- 2008:2020
df <- pivot_longer(df, cols = 1:6, names_to = "State", values_to = "Value")
df
ggplot(df, aes(year, Value, group = State, color = State)) +
...
# Adult HIV Positive Population
df <- as.data.frame(run_stress2[,20:25])
df$year <- 2008:2020
df <- pivot_longer(df, cols = 1:6, names_to = "State", values_to = "Value")
df
ggplot(df, aes(year, Value, group = State, color = State)) +
...
#---------------------------------------------
# STRESS TEST 3: Increase Treatment to 100%
#---------------------------------------------
...
sir <- function(t, x, logkappa)  {
  with(as.list(c(logkappa, x)), {
    ...
    # Whole Population
    t      = 1       # proportion of population who receive treatment 
    b      = 21.5/1000  # birth rate
    a      = 1/14       # aging rate 
    gammat = 0.764      # treatment recovery rate
    gamman = 0.32       # natural recovery rate
...
run_stress3 <- ode(times=times, y=start, func=sir,logkappa_start,maxsteps=100000)
run_stress3



# Child HIV Negative Population
df <- as.data.frame(run_stress3[,2:7])
df$year <- 2008:2020
df <- pivot_longer(df, cols = 1:6, names_to = "State", values_to = "Value")
df
ggplot(df, aes(year, Value, group = State, color = State)) +
...
# Adult HIV Negative Population
df <- as.data.frame(run_stress3[,8:13])
df$year <- 2008:2020
df <- pivot_longer(df, cols = 1:6, names_to = "State", values_to = "Value")
df
ggplot(df, aes(year, Value, group = State, color = State)) +
...
# Child HIV Positive Population
df <- as.data.frame(run_stress3[,14:19])
df$year <- 2008:2020
df <- pivot_longer(df, cols = 1:6, names_to = "State", values_to = "Value")
df
ggplot(df, aes(year, Value, group = State, color = State)) +
...
# Adult HIV Positive Population
df <- as.data.frame(run_stress3[,20:25])
df$year <- 2008:2020
df <- pivot_longer(df, cols = 1:6, names_to = "State", values_to = "Value")
df
ggplot(df, aes(year, Value, group = State, color = State)) +
