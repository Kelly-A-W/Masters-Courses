...
dfl1 <- cbind(dfl_sulf, Drug = "Sulf")
names(dfl1)[names(dfl1) == "Sulfconcentration"] <- "concentration"
dfl2 <- cbind(dfl_pyr, Drug = "Pyr")
names(dfl2)[names(dfl2) == "Pyrconcentration"] <- "concentration"
dfl <- rbind(dfl1, dfl2)
head(dfl)
dfl$Drug <- as.factor(dfl$Drug)
...
#-----------------------------------------------------------------------
dfl <- na.omit(dfl)
fit_gen <- nls(concentration~SSbiexp(day,A1,lrc1,A2,lrc2), data=dfl)
summary(fit_gen)
...
#-----------------------------------------------------------------------
fit_each <- nlsList(concentration~SSbiexp(day,A1,lrc1,A2,lrc2)|pid, data=dfl)
summary(fit_each)
...
start
dfl1 <- groupedData(concentration~day|pid, data = dfl)

fit1 <- nlme(concentration~SSbiexp(day,A1,lrc1,A2,lrc2), data=dfl1,
...
plot(re1, form=A1~Drug, par=list(cex=4), ylab = list(TeX(r'($\b_{1i}$)'), cex=4))
plot(re1, form=A2~Drug, par=list(cex=4), ylab = list(TeX(r'($\b_{3i}$)'), cex=4))
plot(re1, form=lrc2~Drug, par=list(cex=4), ylab = list(TeX(r'($\b_{4i}$)'), cex=4))
...
fit4 <- update(fit3, fixed = c(A1~gender+site+Drug+weight, lrc1~1,  A2 ~ gender+site+Drug+weight+age, lrc2~arm+gender+site+Drug+weight+age),
               start=c(start[1],0,0,0,0,start[2],start[3],0,0,0,0,0,start[4],0,0,0,0,0,0))
summary(fit4)


fit5 <- update(fit3, fixed = c(A1~gender+site+Drug+weight, lrc1~1,  A2 ~ gender+site+Drug+weight+age, lrc2~arm+gender+site+Drug+weight),
               start=c(start[1],0,0,0,0,start[2],start[3],0,0,0,0,0,start[4],0,0,0,0,0))
anova(fit5, fit4)  # choose 5
summary(fit5)


fit6 <- update(fit3, fixed = c(A1~gender+site+Drug+weight, lrc1~1,  A2 ~ site+Drug+weight+age, lrc2~arm+gender+site+Drug+weight),
               start=c(start[1],0,0,0,0,start[2],start[3],0,0,0,0,start[4],0,0,0,0,0))
anova(fit6, fit5)  # choose 6
summary(fit6)



fit7 <- update(fit3, fixed = c(A1~gender+site+Drug+weight, lrc1~1,  A2 ~ site+Drug+age, lrc2~arm+gender+site+Drug+weight),
               start=c(start[1],0,0,0,0,start[2],start[3],0,0,0,start[4],0,0,0,0,0))
anova(fit7, fit6)  # choose 7
summary(fit7)


fit8 <- update(fit3, fixed = c(A1~gender+site+Drug, lrc1~1,  A2 ~ site+Drug+age, lrc2~arm+gender+site+Drug+weight),
               start=c(start[1],0,0,0,start[2],start[3],0,0,0,start[4],0,0,0,0,0))
anova(fit8, fit7)  # choose 8
summary(fit8)


fit9 <- update(fit3, fixed = c(A1~gender+Drug, lrc1~1,  A2 ~ site+Drug+age, lrc2~arm+gender+site+Drug+weight),
               start=c(start[1],0,0,start[2],start[3],0,0,0,start[4],0,0,0,0,0))
anova(fit9, fit8)  # choose 9
summary(fit9)


fit10 <- update(fit3, fixed = c(A1~gender+Drug, lrc1~1,  A2 ~ site+Drug+age, lrc2~arm+gender+Drug+weight),
               start=c(start[1],0,0,start[2],start[3],0,0,0,start[4],0,0,0,0))
anova(fit10, fit9)  # choose 10
summary(fit10)


fit11 <- update(fit3, fixed = c(A1~gender+Drug, lrc1~1,  A2 ~ Drug+age, lrc2~arm+gender+Drug+weight),
                start=c(start[1],0,0,start[2],start[3],0,0,start[4],0,0,0,0))
anova(fit11, fit10)  # choose 11
summary(fit11)


fit12 <- update(fit3, fixed = c(A1~Drug, lrc1~1,  A2 ~ Drug+age, lrc2~arm+gender+Drug+weight),
                start=c(start[1],0,start[2],start[3],0,0,start[4],0,0,0,0))
anova(fit12, fit11)  # choose 11
summary(fit12)


fit12 <- update(fit3, fixed = c(A1~gender, lrc1~1,  A2 ~ Drug+age, lrc2~arm+gender+Drug+weight),
                start=c(start[1],0,start[2],start[3],0,0,start[4],0,0,0,0))
fit12 <- update(fit3, fixed = c(A1~gender+Drug, lrc1~1,  A2 ~ Drug, lrc2~arm+gender+Drug+weight),
                start=c(start[1],0,0,start[2],start[3],0,start[4],0,0,0,0))
fit12 <- update(fit3, fixed = c(A1~gender+Drug, lrc1~1,  A2 ~ age, lrc2~arm+gender+Drug+weight),
                start=c(start[1],0,0,start[2],start[3],0,start[4],0,0,0,0))
fit12 <- update(fit3, fixed = c(A1~gender+Drug, lrc1~1,  A2 ~ Drug+age, lrc2~arm+Drug+weight),
                start=c(start[1],0,0,start[2],start[3],0,0,start[4],0,0,0))
fit12 <- update(fit3, fixed = c(A1~gender+Drug, lrc1~1,  A2 ~ Drug+age, lrc2~arm+gender+weight),
                start=c(start[1],0,0,start[2],start[3],0,0,start[4],0,0,0))
fit12 <- update(fit3, fixed = c(A1~gender+Drug, lrc1~1,  A2 ~ Drug+age, lrc2~arm+gender+Drug),
                start=c(start[1],0,0,start[2],start[3],0,0,start[4],0,0,0))


#  CHOOSE MODEL 11
plot(fit11, adj=-1, pch=20, col="black")
...
df10 <- data.frame(residuals = resid(fit11), 
                   fitted = predict(fit11))
ggplot(data = df10,
...
plot(fit11, resid(.,type="pearson")~fitted(.)|arm, adj=-0.3, 
     pch = 20, col= "black",
     par=list(cex=2), ylab = list("Pearson residuals", cex=2), xlab = list("Fitted values", cex=2))

plot(fit11, resid(.,type="pearson")~fitted(.)|gender, adj=-0.3, 
     pch = 20, col= "black",
     par=list(cex=2), ylab = list("Pearson residuals", cex=2), xlab = list("Fitted values", cex=2))

plot(fit11, resid(.,type="pearson")~fitted(.)|Drug, adj=-0.3, 
     pch = 20, col= "black",
     par=list(cex=2), ylab = list("Pearson residuals", cex=2), xlab = list("Fitted values", cex=2))
...
# Weight
dfb <- data.frame(residuals = resid(fit11,type="pearson"), 
                  fitted = dfl$weight)
ggplot(data = dfb,
       aes(x = fitted, y = residuals)) +
  geom_point(size=2) + 
...
fit20 <- update(fit11, weights=varPower(form= ~age))
anova(fit20,fit11)
fit20 <- update(fit11, weights=varPower(form = ~weight))
anova(fit20,fit11)
fit20 <- update(fit11, weights=varFixed(~age))
fit20 <- update(fit11, weights=varFixed(~weight))
fit20 <- update(fit11, weights=varFixed(~age+weight))
summary(fit20)
...
#-----------------------------------------------------------------------
plot(fit11, resid(.)~day, abline=0)
plot(Variogram(fit11), form=~day)

fit30 <- update(fit11, correlation=corCompSymm())
fit31 <- update(fit11, correlation=corSymm())
fit32 <- update(fit11, correlation=corAR1())
anova(fit11, fit30)
...
qqnorm(fit11, col="black", pch=20, ylab = list("Quantiles of standard normal", cex=2), xlab = list("Standardised residuals", cex=2))
qqnorm(fit11, ~resid(.)|arm, col="black", pch=20, ylab = list("Quantiles of standard normal", cex=2), xlab = list("Standardised residuals", cex=2))
qqnorm(fit11, ~resid(.)|gender, col="black", pch=20, ylab = list("Quantiles of standard normal", cex=2), xlab = list("Standardised residuals", cex=2))
qqnorm(fit11, ~resid(.)|Drug, col="black", pch=20, ylab = list("Quantiles of standard normal", cex=2), xlab = list("Standardised residuals", cex=2))


qqnorm(fit11, ~ranef(.), col="black", pch=20, ylab = list("Quantiles of standard normal", cex=2), xlab = list("Standardised residuals", cex=2), par=list(cex=2))


df <- data.frame(sul = dfl$concentration, 
                 fitted = fitted(fit11), 
                 drug = dfl$Drug)
ggplot(data = df,
       aes(x = fitted, y = sul, col=drug)) +
  geom_point(size=2) + 
...
fit <- update(fit3, fixed = c(A1~gender+Drug, lrc1~1,  A2 ~ Drug+age, lrc2~arm+gender+Drug+weight),                 
              start=c(start[1],0,0,start[2],start[3],0,0,start[4],0,0,0,0), method ='REML')
summary(fit)
